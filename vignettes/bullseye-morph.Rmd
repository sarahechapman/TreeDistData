...
MethodLegend <- function () {
  legend('topleft', rep('', length(tdMethods)), col=TreeDistCol(tdMethods, 88),
         lwd = 3, lty = 1, bty='n')
  legend('topleft', tdAbbrevs[tdMethods], col=TreeDistCol(tdMethods),
         lwd = lwd, lty = 1, bty='n')


  #legend('left', c(abbrevs[tdMethods[7:8]], '', '', 'Mean', 'Std. Err.'),
  #       col=c(methodCol[tdMethods[7:8]], 'white', 'white', 'black',
...
```{r bullseye-results, echo=FALSE, fig.width=7.2, fig.asp = 4.2/4}
PlotFunc()
```
