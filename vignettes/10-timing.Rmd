...
nRepeats <- 10L # Increase locally for slower but more accurate benchmarking
...
Times <- function (trees) {
  ...
  timings <- microbenchmark::microbenchmark(
    ...
    nea = NyeSimilarity(splits, normalize = FALSE),
    ja2 = JaccardRobinsonFoulds(splits, k = 2L, similarity = TRUE, allowConflict = FALSE, normalize = FALSE),
    ja4 = JaccardRobinsonFoulds(splits, k = 4L, similarity = TRUE, allowConflict = FALSE, normalize = FALSE),
    jna2 = JaccardRobinsonFoulds(splits, k = 2L, similarity = TRUE, allowConflict = TRUE, normalize = FALSE),
    jna4 = JaccardRobinsonFoulds(splits, k = 4L, similarity = TRUE, allowConflict = TRUE, normalize = FALSE),
