...
vignette: >
  %\VignetteIndexEntry{2.2: Context: tree distance values}
...
msNorm <- nls(msMax ~ (a * nTip) + (c * nTip ^ b) + d,
...
Average range of distance between random trees with 20-200 leaves, 
