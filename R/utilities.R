...
AllDists <- function (tr1, tr2, verbose = FALSE) {
  ...
  Bind(
    ...
    ja2 = JaccardRobinsonFoulds(tr1, tr2, k = 2, coherent = TRUE, normalize = TRUE),
    ja4 = JaccardRobinsonFoulds(tr1, tr2, k = 4, coherent = TRUE, normalize = TRUE),
    jna2 =JaccardRobinsonFoulds(tr1, tr2, k = 2, coherent = FALSE, normalize = TRUE),
    jna4 =JaccardRobinsonFoulds(tr1, tr2, k = 4, coherent = FALSE, normalize = TRUE),
...
CompareAllTrees <- function (trees, exact = FALSE, slow = TRUE,
  ...
  list(
    ...
    ja2 =  JaccardRobinsonFoulds(splits, k = 2, coherent = TRUE, normalize = TRUE),
    ja4 =  JaccardRobinsonFoulds(splits, k = 4, coherent = TRUE, normalize = TRUE),
    jna2 = JaccardRobinsonFoulds(splits, k = 2, coherent = FALSE, normalize = TRUE),
    jna4 = JaccardRobinsonFoulds(splits, k = 4, coherent = FALSE, normalize = TRUE),
